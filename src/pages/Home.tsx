  ...
  return (
    <div className="relative w-full bg-[#1b2c7a] mt-[-1px]">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div 
          className="absolute inset-0 bg-no-repeat bg-[left_100px] md:bg-[left_center] bg-[length:120%_auto] sm:bg-[length:90%_auto] md:bg-[length:70%_auto] lg:bg-[length:60%_auto]"
          style={{ 
            backgroundImage: "url('https://raw.githubusercontent.com/jason-public/e-promise/d6264983573682b9c532424d9320a2f03ad51caa/public/hero-bg.webp')",
      ...
      <div className="relative z-10 flex items-center min-h-[calc(100vh-80px)] md:min-h-[700px] lg:min-h-[800px] overflow-hidden">
        ...
        <div className="relative z-10 w-full flex justify-end px-6 py-24 md:py-32 lg:py-40 md:pr-16 lg:pr-32 text-right">
          <motion.div
             ...
             className="flex flex-col items-end max-w-2xl mt-48 sm:mt-56 md:mt-0"
          >
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 mt-8 w-full justify-end">
             ...
             <br className="hidden sm:block" />
                     <div className="text-[16px] md:text-[17px] text-gray-200 font-medium tracking-tight break-keep drop-shadow-md shadow-black/50 flex flex-col gap-5 text-right leading-relaxed mb-10">
